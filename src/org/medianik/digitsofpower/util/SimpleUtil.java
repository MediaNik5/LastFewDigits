...
public class SimpleUtil {
    ...
    public static long optimizedPowWithLimitOfDigits(long number, long power, int limitOfDigits, int module) {
        long output = 1;
    ...
    public static void setStringsInRowWithSeparation(StringBuilder sb, String[] data, int firstIncluding, int lastExcluding, String separator){
    ...
    public static void setNumbersInRowWIthSeparation(StringBuilder sb, long firstNumber, long step, int amount, String separator) {
    ...
    public static int numberOfDigits(long numbers) {
        // Guessing 4 digit numbers will be more probable.
        // They are set in the first branch.
        if (numbers < 10000L) { // from 1 to 4
            if (numbers < 100L) { // 1 or 2
                if (numbers < 10L)
                    return 1;
                else
                    return 2;
            ...
            if (numbers < 1000000000000L) { // from 5 to 12
                if (numbers < 100000000L) { // from 5 to 8
                    if (numbers < 1000000L) { // 5 or 6
                        if (numbers < 100000L)
                            return 5;
                        else
                            return 6;
                    ...
                    if (numbers < 10000000000L) { // 9 or 10
                        if (numbers < 1000000000L)
                            return 9;
                        else
                            return 10;

                    } else { // 11 or 12
                        if (numbers < 100000000000L)
                            return 11;
                        else
                            return 12;
                ...
                if (numbers < 10000000000000000L) { // from 13 to 16
                    if (numbers < 100000000000000L) { // 13 or 14
                        if (numbers < 10000000000000L)
                            return 13;
                        else
                            return 14;

                    } else { // 15 or 16
                        if (numbers < 1000000000000000L)
                            return 15;
                        else
                            return 16;
                    }
                } else { // from 17 to 18
                    if (numbers < 100000000000000000L)
                        return 17;
                    else
                        return 18;
                }
